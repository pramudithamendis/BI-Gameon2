...
FROM
    gaming_app_backend2.user_game_session a,
    gaming_app_backend2.user u,
    gaming_app_backend2.game_session gs,
    gaming_app_backend2.game_session_mode gsm,
    gaming_app_backend2.game_session_status gss,
    gaming_app_backend2.user_coin_action uca,
    gaming_app_backend2.user_coin_action_type ucat
