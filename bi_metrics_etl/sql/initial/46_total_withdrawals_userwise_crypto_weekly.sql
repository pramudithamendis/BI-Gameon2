...
insert into total_withdrawals_userwise_crypto_weekly(user_id, email,first_name,last_name,year,week_number,week_label,total_completed_amount,total_transactions) 
