...
insert into total_withdrawals_userwise_crypto_cumulative(user_id,email,first_name,last_name,total_completed_amount,total_transactions) 
...
select * from total_withdrawals_userwise_crypto_daily;