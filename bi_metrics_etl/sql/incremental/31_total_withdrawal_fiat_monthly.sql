...
insert into total_withdrawal_fiat_monthly(month_,total_completed_amount,total_transactions)
SELECT 
...
and w.created_at >= @cutoff AND DATE_FORMAT(CONVERT_TZ(w.created_at, '+00:00', '+08:00'), '%%Y-%%m') = @last_month
