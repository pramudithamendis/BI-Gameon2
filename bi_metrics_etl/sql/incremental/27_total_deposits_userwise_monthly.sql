...
insert into total_deposits_both_monthly_userwise(user_id,email,first_name,last_name,month_,total_completed_amount,total_transactions) 
...
WHERE w.created_at >= @cutoff and (w.user_coin_transaction_method = 4 or w.user_coin_transaction_method = 5) AND DATE_FORMAT(CONVERT_TZ(w.created_at, '+00:00', '+08:00'), '%Y-%m') = @last_month
